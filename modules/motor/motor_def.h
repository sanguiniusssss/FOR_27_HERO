...
typedef enum
{
    MOTOR_FEED = 0,// 电机自身传感器反馈,角度反馈为total_angle,速度反馈为speed_aps
    OTHER_FEED,// 电机自身传感器反馈或其他数据来源,需要在Motor_Controller_s中设置对应的指针
} Feedback_Source_e;
...
typedef struct
{
    ...
    PID_Init_Config_s gyro_PID;
    PID_Init_Config_s speed_PID;
    PID_Init_Config_s angle_PID;
    PID_Init_Config_s current_PID;
    SMC_Init_Config_s smc;
